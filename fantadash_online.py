...
def update_output(n_clicks, input_value, output_state):
    if n_clicks and input_value:
        ...
        df = pd.read_csv("https://raw.githubusercontent.com/Spasella/dataset/main/fantabot_dataset%20-%202021-2022.csv",
                         low_memory=False)

        #Richiamiamo il llm di OpenAI
        llm = OpenAI(api_token='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')
